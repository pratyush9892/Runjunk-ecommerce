...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91 8579027841", path: '/', icon: MailIcon },
                { text: "techpqr@gmail.com", path: '/', icon: PhoneIcon },
                { text: "NIT Nagaland", path: '/', icon: MapPinIcon }
            ]
        }
    ];
    ...
    const socialIcons = [
        ...
        { icon: LinkedinIcon, link: "https://www.linkedin.com/in/pratyush9892/" },
    ]
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">mus</span>atra<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to Musatra — a world where technology meets sophistication. Discover a curated selection of next-generation smartphones, smartwatches, and accessories designed to elevate everyday living. At Musatra, innovation isn’t just delivered — it’s experienced.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © musatra All Right Reserved to butcher.
                </p>
            </div>
        </footer>
    );
